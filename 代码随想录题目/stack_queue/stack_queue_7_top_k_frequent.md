...
- **解析 / 学习链接**：  
  ...
  - [🎥 视频讲解（代码随想录）- 大小顶堆，推荐观看](https://www.bilibili.com/video/BV1Xg41167Lz/?vd_source=7923b10dbf11c28879c337d8e0bfa8de)
...
1. **比较器的反向逻辑**
   - **机制**：`lhs.second > rhs.second`表示"**左边频率大于右边时，左边优先级更低**"，大于的一方优先级更低
